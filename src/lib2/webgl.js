...
export function generate(
  ...
  withWebGLContext(
    glOrCanvas,
    ({ gl, withTexture, withTextureFramebuffer }) => {
...
export function generateIntoFramebuffer(
  ...
  withWebGLContext(
    ...
    ({
      ...
      withTexture(
        "rawDistances",
        (intermediateTexture, intermediateTextureUnit) => {
          if (
          ...
          withProgram(
            ...
            mainVertex,
            mainFragment,
            ({ setAttribute, setUniform }) => {
              // Init extensions
              const instancingExtension =
                !isWebGL2 && getExtension("ANGLE_instanced_arrays");
              const blendMinMaxExtension =
                !isWebGL2 && getExtension("EXT_blend_minmax");
